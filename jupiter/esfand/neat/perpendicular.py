			...
			for k in [0, 1]:
				for l in [0, 1]:
					...
					s += A * Kss(Limits[0][i] - Limits[1][j], Limits[2][k] - y, \
								 Limits[3][l] - z)
	return s
# In below function: It is assumed that tiles are square ( not rectangular )
# And also assumed that two squares have same length
# It is necassary to write a function without these limits.
...
if __name__ == "__main__":
	d = 0; 	Lx = 100; Ly = 1; z = 1e-9
	print ("%e" %perpendicular(Lx, Ly, 0, 0 , 0))
