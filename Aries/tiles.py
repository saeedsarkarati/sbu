# این برنامه برای تعریف کلاس‌های لازم برای کاشی‌‌ها در برنامه محاسبه ظرفیت خازنی نوشته شده است.
# در این برنامه فرض شده است که هر کاشی حد اکثر یک قسمت خالی یا hole دارد
import sys
...
# فرض می‌کنیم که هر tile یک و فقط یک hole داشته باشد.
Tx, Ty, Tz, Tlx, Tly, Hx, Hy, Hz, Hlx, Hly = ss_init()
...
# ----------------
TIM = true_indices_matrix(IS)
# چاپ ماتریس نهایی
print(TIM)
print (THx)
print (THy)
# Pij = parallel_coplanar (Tlx, Tly, Tlx, Tly, dx, dy)
